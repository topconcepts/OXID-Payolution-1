...
[{if $module->shouldIncludeModal()}]
    ...
    [{oxstyle include=$oViewConf->getModuleUrl("tcpayolution", "out/src/css/jquery-ui.min.css") priority=1}]
    [{oxstyle include=$oViewConf->getModuleUrl("tcpayolution", "out/src/css/jquery-ui-slider-pips.css") priority=10}]
    [{oxstyle include=$oViewConf->getModuleUrl("tcpayolution", "out/src/css/payolution.css") priority=11}]
    ...
    [{oxscript include=$oViewConf->getModuleUrl("tcpayolution", "out/src/js/libs/payolution.jquery-ui.min.js") priority=2}]
    [{oxscript include=$oViewConf->getModuleUrl("tcpayolution", "out/src/js/widgets/oxmodalpopup.js") priority=10}]
    [{oxscript include=$oViewConf->getModuleUrl("tcpayolution", "out/src/js/libs/accounting.js") priority=10}]
    [{oxscript include=$oViewConf->getModuleUrl("tcpayolution", "out/src/js/libs/jquery-ui-slider-pips.min.js") priority=9}]
    ...
    [{oxscript include=$oViewConf->getModuleUrl("tcpayolution", "out/src/js/payo-installment-modal.js") priority=10}]
